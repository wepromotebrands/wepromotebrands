...
function AccentPurpleButtonLong(props) {
    ...
    return(
        <View style={styles.outerContainer}>
            ...
            <LinearGradient colors={['#6c4dda', '#522ED2']} start={[0.0, 0.5]} end={[0.8, 0.5]} locations={[0.0, 1.0]}>
...
export default AccentPurpleButtonLong
