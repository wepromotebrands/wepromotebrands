...
function OnBoardingAudioScreen({ navigation }) {
  return(
      ...
      <SafeAreaView style={[styles.container, {}]}>
        ...
        <View style={styles.container2}>
          ...
          <View style={styles.containerMitte}>
            <Text style={styles.text}>Audio Video Chat</Text> 
            <Text style={styles.text}>Lot of Fun</Text>
            ...
            <PrimaryButton onPress={() => {navigation.navigate("WelcomeScreen")}}>Get Started</PrimaryButton>
...
export default OnBoardingAudioScreen
