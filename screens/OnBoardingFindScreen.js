...
function OnBoardingFindScreen({ navigation }) {
  return(
      ...
      <SafeAreaView style={[styles.container, {}]}>
        ...
        <View style={styles.container2}>
          ...
          <View style={styles.containerMitte}>
            ...
            <PrimaryButton onPress={() => {navigation.navigate("OnBoardingAudioScreen")}}>Get Started</PrimaryButton>
...
export default OnBoardingFindScreen
